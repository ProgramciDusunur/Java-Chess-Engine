...
public class Tahta implements MouseListener,MouseMotionListener  {
	...
	public void arayuzCizilecekLegalHamleler(boolean hamleAl,boolean sahKontrol) {		
		...
		for (byte i = 0, j = 8;i < tahta.length;i++) {			
			...
			if (acmazKontrol() == "acmazYok" && arayuzHamle[0].charAt(1) == kare && tahta[i] == "F" && arayuzHamle[0].charAt(0) == 'F' && Character.getNumericValue(arayuzHamle[0].charAt(2)) == j || arayuzHamle[0].charAt(1) == kare && tahta[i] == "f" && arayuzHamle[0].charAt(0) == 'f' && Character.getNumericValue(arayuzHamle[0].charAt(2)) == j || hamleAl && tahta[i] == "F" || hamleAl && tahta[i] == "f") {				
			...
			if (acmazKontrol() == "acmazYok" && arayuzHamle[0].charAt(1) == kare && tahta[i] == "V" && arayuzHamle[0].charAt(0) == 'V' && Character.getNumericValue(arayuzHamle[0].charAt(2)) == j || acmazKontrol() == "acmazYok" && arayuzHamle[0].charAt(1) == kare && tahta[i] == "v" && arayuzHamle[0].charAt(0) == 'v' && Character.getNumericValue(arayuzHamle[0].charAt(2)) == j || hamleAl && tahta[i] == "V" || hamleAl && tahta[i] == "v") {				
			...
			else if (acmazKontrol() != "acmazYok" && arayuzHamle[0].charAt(0) == 'v' || acmazKontrol() != "acmazYok" && arayuzHamle[0].charAt(0) == 'V') {				
				for (byte p = 1;p < 8;p++) {
					if (acmazKontrol() == "acmazUstDikey") {											
						if (tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+p)) >= 1 && tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+p)) <= 8 && ustDikey) {							
							if (Character.isUpperCase(arayuzHamle[0].charAt(0))&& !Character.isUpperCase(tahta[tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1+p))*8+Character.getNumericValue(arayuzHamle[0].charAt(1))-10].charAt(0)) || Character.isLowerCase(arayuzHamle[0].charAt(0))&& !Character.isLowerCase(tahta[tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1+p))*8+Character.getNumericValue(arayuzHamle[0].charAt(1))-10].charAt(0))) {
								tasLegalHamle.add(Character.toString(arayuzHamle[0].charAt(1))+String.valueOf(arayuzHamle[0].charAt(2)-48+p));
							}
							else {
								ustDikey = false;
							}							
						}						
						if (tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1-p))*8+Character.getNumericValue(arayuzHamle[0].charAt(1))-10 <= 63) {if (Character.isUpperCase(arayuzHamle[0].charAt(0)) && Character.isUpperCase(arayuzHamle[0].charAt(0)) == Character.isUpperCase(tahta[tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1-p))*8+Character.getNumericValue(arayuzHamle[0].charAt(1))-10].charAt(0)) || Character.isLowerCase(arayuzHamle[0].charAt(0)) && Character.isLowerCase(arayuzHamle[0].charAt(0)) == Character.isLowerCase(tahta[tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1-p))*8+Character.getNumericValue(arayuzHamle[0].charAt(1))-10].charAt(0)) ) {altDikey = false;}}
						if (tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))-p)) >= 1 && tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))-p)) <= 8 && altDikey) {
							tasLegalHamle.add(Character.toString(arayuzHamle[0].charAt(1))+String.valueOf(arayuzHamle[0].charAt(2)-48-p));
						}																				
					}
					ustDikey = true;
					altDikey = true;
					if (acmazKontrol() == "acmazAltDikey") {						
						...
						if (tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1+p))*8+Character.getNumericValue(arayuzHamle[0].charAt(1))-10 <= 63) {if (Character.isUpperCase(arayuzHamle[0].charAt(0)) && Character.isUpperCase(arayuzHamle[0].charAt(0)) == Character.isUpperCase(tahta[tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1+p))*8+Character.getNumericValue(arayuzHamle[0].charAt(1))-10].charAt(0)) || Character.isLowerCase(arayuzHamle[0].charAt(0)) && Character.isLowerCase(arayuzHamle[0].charAt(0)) == Character.isLowerCase(tahta[tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1+p))*8+Character.getNumericValue(arayuzHamle[0].charAt(1))-10].charAt(0))) {ustDikey = false;}}
						if (tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+p)) >= 1 && tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+p)) <= 8 && ustDikey) {
							tasLegalHamle.add(Character.toString(arayuzHamle[0].charAt(1))+String.valueOf(arayuzHamle[0].charAt(2)-48+p));
						}
					}
					ustDikey = true;
					altDikey = true;
					if (acmazKontrol() == "acmazSagAltKose") {						
						if (tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1-p)) >= 1 && tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1-p)) <= 8 && Character.getNumericValue(arayuzHamle[0].charAt(1))-10+p >= 1 && Character.getNumericValue(arayuzHamle[0].charAt(1))-10+p < 8 && sagAltKose) {
							if (tahta[tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1-p))*8+Character.getNumericValue(arayuzHamle[0].charAt(1))-10+p] != " ") {
								...
								if (Character.isUpperCase(arayuzHamle[0].charAt(0)) && !Character.isUpperCase(tahta[tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1-p))*8+Character.getNumericValue(arayuzHamle[0].charAt(1))-10+p].charAt(0))) {
									tasLegalHamle.add((char)(Character.getNumericValue(arayuzHamle[0].charAt(1))-9+p+96)+String.valueOf(arayuzHamle[0].charAt(2)-48-p));
								}
								sagAltKose = false;
							}																		
						}							
						if (sagAltKose) {tasLegalHamle.add((char)(Character.getNumericValue(arayuzHamle[0].charAt(1))-9+p+96)+String.valueOf(arayuzHamle[0].charAt(2)-48-p));}
						if (tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+p)) >= 1 && tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+p)) <= 8 && Character.getNumericValue(arayuzHamle[0].charAt(1))-10-p >= 1 && Character.getNumericValue(arayuzHamle[0].charAt(1))-10-p < 8 && ustDikey) {							
							if (Character.isUpperCase(arayuzHamle[0].charAt(0))&& !Character.isUpperCase(tahta[tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1+p))*8+Character.getNumericValue(arayuzHamle[0].charAt(1))-10-p].charAt(0)) || Character.isLowerCase(arayuzHamle[0].charAt(0))&& !Character.isLowerCase(tahta[tahtaDikeyCeviri((byte) ((byte)Character.getNumericValue(arayuzHamle[0].charAt(2))+1+p))*8+Character.getNumericValue(arayuzHamle[0].charAt(1))-10-p].charAt(0))) {
								tasLegalHamle.add((char)(Character.getNumericValue(arayuzHamle[0].charAt(1))-9-p+96)+String.valueOf(arayuzHamle[0].charAt(2)-48+p));
							}
							else {
								solUstKose = false;
						...
						//if (solUstKose) {tasLegalHamle.add((char)(Character.getNumericValue(arayuzHamle[0].charAt(1))-9-p+96)+String.valueOf(arayuzHamle[0].charAt(2)-48+p));}
					}
					sagAltKose = true;
					solUstKose = true;
				}
				
				//System.out.println("Hedef Vezir Açmazda");
				if (hamleAl) {solUstKose = true;sagUstKose = true;solAltKose = true;sagAltKose = true;}
				if (hamleAl) {ustDikey = true;altDikey = true;solYatay = true;sagYatay = true;}
			}
