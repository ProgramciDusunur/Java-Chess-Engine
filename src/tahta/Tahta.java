...
public class Tahta implements MouseListener,MouseMotionListener  {
    ...
    public void arayuzCizilecekLegalHamleler(boolean hamleAl,boolean sahKontrol) {
        ...
        for (byte i = 0, j = 8;i < tahta.length;i++) {
            ...
            if (acmazKontrol() == "acmazYok" && arayuzHamle[0].charAt(1) == kare && tahta[i] == "P" && arayuzHamle[0].charAt(0) == 'P' && Character.getNumericValue(arayuzHamle[0].charAt(2)) == j || arayuzHamle[0].charAt(1) == kare && tahta[i] == "p" && arayuzHamle[0].charAt(0) == 'p' && Character.getNumericValue(arayuzHamle[0].charAt(2)) == j || hamleAl && tahta[i] == "P" || hamleAl && tahta[i] == "p") {
