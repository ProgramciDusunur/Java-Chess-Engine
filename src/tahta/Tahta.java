...
public class Tahta implements MouseListener,MouseMotionListener  {
    ...
    public LinkedList<Integer> cizilecekHamleler = new LinkedList<Integer>();
    ...
    public void yeniHamle() {
    	...
    	for (int i : cizilecekHamleler) {
    		...
    		if (i > 0) {    			
    			if ((i/10000)%10 == (arayuzHamle2[1]%10) && (i/1000)%10 == (arayuzHamle2[1]/10)%10 || (i/10000)%10 == ((arayuzHamle2[1]*-1)%10) && (i/1000)%10 == ((arayuzHamle2[1]*-1)/10)%10) {    				    				    				
    ...
    public void yeniArama(boolean motor) {
		...
		for (byte i = 0;i < tahta.length;i++) {									
			...
			if (tahta[i] == 3 && arayuzHamle2[0] / 100 == 3 && (arayuzHamle2[0]/10)%10 == i%8 && arayuzHamle2[0]%10 == i/8 || tahta[i] == -3 && arayuzHamle2[0] / 100 == -3 && ((arayuzHamle2[0]/10)%10)*-1 == i%8 && (arayuzHamle2[0]%10)*-1 == i/8 || tahta[i] == 3 && motor || tahta[i] == -3 && motor) {				
				if (tahta[i] == 3 && i/8-2 > -1 && i%8-1 > -1 && tahta[((i/8)-2)*8+i%8-1] < 1 || tahta[i] == -3 && i/8-2 > -1 && i%8-1 > -1 && tahta[((i/8)-2)*8+i%8-1] > -1) {if (tahta[i] > 0) {cizilecekHamleler.add(3*100000+(i/8-2)*10000+(i%8-1)*1000+(i/8)*100+(i%8)*10);}else {cizilecekHamleler.add(-900*100000-(i/8-2)*10000-(i%8-1)*1000-(i/8)*100-(i%8)*10);}}				
				System.out.println("Arayüz taþ dikey = "+arayuzHamle2[0]%10);
				System.out.println("Nasýl ya "+(3*100000+(i/8+2)*10000+(i%8-1)*1000+(i/8)*100+(i%8)*10));
			}
			//Bishop movements, Fil hareketleri
			if (tahta[i] == 4 && arayuzHamle2[0] / 100 == 4 || tahta[i] == -4 && arayuzHamle2[0] / 100 == -4 || tahta[i] == 4 && motor || tahta[i] == -4 && motor) {				
				
			}
			//Rook movements, Kale hareketleri
			if (tahta[i] == 5 && arayuzHamle2[0] / 100 == 5 || tahta[i] == -5 && arayuzHamle2[0] / 100 == -5 || tahta[i] == 5 && motor || tahta[i] == -5 && motor) {			
				
			}
			//Queen movements, Vezir hareketleri
			if (tahta[i] == 9 && arayuzHamle2[0] / 100 == 9 || tahta[i] == -9 && arayuzHamle2[0] / 100 == -9 || tahta[i] == 9 && motor || tahta[i] == -9 && motor) {			
				
			}
			//Pawn movements, Piyon hareketleri
			if (tahta[i] == 1 && arayuzHamle2[0] / 100 == 1 || tahta[i] == -1 && arayuzHamle2[0] / 100 == -1 || tahta[i] == 1 && motor || tahta[i] == -1 && motor) {			
