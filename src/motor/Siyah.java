...
public class Siyah {
	...
	public void piyon(int i, int x, int y, int[] tahta, PerformansTest p) {
		...
		if (p.getGecerkenAlma() > -1 && Math.abs(p.getGecerkenAlma()-i%8) == 1 && i/8 == 4 && gecerkenAlmaAcmaz(i,tahta,p)) {hamle.add(1*10000000+(i/8+1)*10000+(p.getGecerkenAlma())*1000+(i/8)*100+(i%8)*10);}
	}
	public void sahCekisArama(int tas, int i, int[] tahta, PerformansTest k) {		
		 ...
		 for (int p = 0;p < mudaheleKareleri.size();p++) {
			 ...
			 case -3:
				 ...
				 break;
			 case -1:
				 if (i/8 == 1 && tahta[(i/8+2)*8+i%8] == 0 && tahta[(i/8+1)*8+i%8] == 0 && (i/8+2)*8+i%8 == mudaheleKareleri.get(p)) {hamleEkle(-10,i,i%8,i/8+2,tahta);}
	    			if (tahta[(i/8+1)*8+i%8] == 0 && (i/8+1)*8+i%8 == mudaheleKareleri.get(p)) {hamleEkle(tas,i,i%8,i/8+1,tahta);}	    			
	    			if ((i/8+1 < 7 && i%8-1 > -1) && tahta[(i/8+1)*8+i%8-1] > 0 && (i/8+1)*8+i%8-1 == mudaheleKareleri.get(p)) {hamleEkle(tas,i,i%8-1,i/8+1,tahta);}
	    			if ((i/8+1 < 7 && i%8+1 < 8) && tahta[(i/8+1)*8+i%8+1] > 0 && (i/8+1)*8+i%8+1 == mudaheleKareleri.get(p)) {hamleEkle(tas,i,i%8+1,i/8+1,tahta);}
