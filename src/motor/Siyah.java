...
public class Siyah extends OrtakHesap {	
	...
	public void piyon(int i, int x, int y, int[] tahta, PerformansTest p) {
		if (piyonAcmazTest(i,tahta[i],tahta,p) == 0) {
			if (p.getSiyahSahCekis() == 0) {
				if (y+1 < 7 && tahta[i+8] == 0.0) {hamleEkle(tahta[i],i,x,y+1);}
				if (y == 1 && tahta[i+16] == 0.0 && tahta[i+8] == 0.0) {hamleEkle(-10,i,x,y+2);}
				if (x-1 > -1 && y+1 < 7 && tahta[i+7] > 0) {hamleEkle(tahta[i],i,x-1,y+1);}
				if (x+1 < 8  && y+1 < 7 && tahta[i+9] > 0) {hamleEkle(tahta[i],i,x+1,y+1);}		
				if (y == 6 && tahta[i+8] == 0.0) {hamleEkle(-9000,i,x,y+1);hamleEkle(-400,i,x,y+1);hamleEkle(-300,i,x,y+1);hamleEkle(-500,i,x,y+1);}		
				if (x-1 > -1 && y == 6 && tahta[i+7] > 0) {hamleEkle(-9000,i,x-1,y+1);hamleEkle(-400,i,x-1,y+1);hamleEkle(-300,i,x-1,y+1);hamleEkle(-500,i,x-1,y+1);}
				if (x+1 < 8  && y == 6 && tahta[i+9] > 0) {hamleEkle(-9000,i,x+1,y+1);hamleEkle(-400,i,x+1,y+1);hamleEkle(-300,i,x+1,y+1);hamleEkle(-500,i,x+1,y+1);}
				if (p.getGecerkenAlma() > -1 && Math.abs(p.getGecerkenAlma()-i%8) == 1 && i/8 == 4 && gecerkenAlmaAcmaz(i,tahta,p)) {hamleEkle(-100,i,p.getGecerkenAlma(),y+1);}
			} else if (p.getSiyahSahCekis() == 1) {
				sahCekisArama(tahta[i],i,i%8,i/8,tahta,p);
			}
		}		
	...
	public void sahCekisArama(int tasDeger, int tasKonum, int x, int y, int[] tahta, PerformansTest k) {		
		 ...
		 for (int p = 0;p < mudaheleKareleri.size();p++) {
			 switch(tasDeger) {
			 case -1:
				 if (y == 1 && tahta[tasKonum+16] == 0 && tahta[tasKonum+8] == 0 && tasKonum+16 == mudaheleKareleri.get(p)) {hamleEkle(-10,tasKonum,x,y+2);}
				 if (y+1 < 7 && tahta[tasKonum+8] == 0 && tasKonum+8 == mudaheleKareleri.get(p)) {hamleEkle(-1,tasKonum,x,y+1);}	    			
				 if ((y+1 < 7 && x-1 > -1) && tahta[tasKonum+7] > 0 && tasKonum+7 == mudaheleKareleri.get(p)) {hamleEkle(-1,tasKonum,x-1,y+1);}
				 if ((y+1 < 7 && x+1 < 8) && tahta[tasKonum+9] > 0 && tasKonum+9 == mudaheleKareleri.get(p)) {hamleEkle(-1,tasKonum,x+1,y+1);}
				 if (y == 4 && k.getGecerkenAlma() > -1 && Math.abs(k.getGecerkenAlma()-x) == 1 && tahta[mudaheleKareleri.get(p)] == 1) {hamleEkle(-100,tasKonum,k.getGecerkenAlma(),y+1);}
				 if (y == 6 && (tahta[mudaheleKareleri.get(p)] == 0)  && tasKonum+8 == mudaheleKareleri.get(p)) {hamleEkle(-9000,tasKonum,x,y+1);hamleEkle(-400,tasKonum,x,y+1);hamleEkle(-300,tasKonum,x,y+1);hamleEkle(-500,tasKonum,x,y+1);}
				 if (y == 6 && (tahta[mudaheleKareleri.get(p)] > 0) && tasKonum+7 == mudaheleKareleri.get(p)) {hamleEkle(-9000,tasKonum,x-1,y+1);hamleEkle(-400,tasKonum,x-1,y+1);hamleEkle(-300,tasKonum,x-1,y+1);hamleEkle(-500,tasKonum,x-1,y+1);}
				 if (y == 6 && (tahta[mudaheleKareleri.get(p)] > 0) && tasKonum+9 == mudaheleKareleri.get(p)) {hamleEkle(-9000,tasKonum,x+1,y+1);hamleEkle(-400,tasKonum,x+1,y+1);hamleEkle(-300,tasKonum,x+1,y+1);hamleEkle(-500,tasKonum,x+1,y+1);}
				 break;
			 case -3:
	...
	public void hamleEkle(int j, int i, int x, int y) {		
		hamle.add((j*100000-(y)*10000-(x)*1000-(i/8)*100-(i%8)*10)*-1);		
	}
	...
	public int acmazTestYatayVeDikey(int hedefTasKare, int tasDeger, int[] tahta, PerformansTest p, int sahX, int sahY) {
		if (sahX == hedefTasKare%8 && sahY > hedefTasKare/8) {			
    		return acmazKontrol(tasDeger,1,hedefTasKare,(sahY - hedefTasKare/8)-1,tahta,p);
    	}
    	else if (sahX == hedefTasKare%8 && sahY < hedefTasKare/8) {    		
	...
	public int acmazTestCapraz(int hedefTasKare, int tasDeger, int[] tahta, PerformansTest p, int sahX, int sahY) {
		if ((sahY*8+sahX) %9 == hedefTasKare%9 && sahY > hedefTasKare/8 && sahX > hedefTasKare%8) {    		
    		return acmazKontrol(tasDeger,5,hedefTasKare,(sahY*8+sahX-hedefTasKare)/9-1,tahta,p);
    	}
    	else if ((sahY*8+sahX) %9 == hedefTasKare%9 && sahY < hedefTasKare/8 && sahX < hedefTasKare%8) {    		
    		return acmazKontrol(tasDeger,6,hedefTasKare,(hedefTasKare-(sahY*8+sahX))/9-1,tahta,p);
    	}
    	else if ((sahY*8+sahX) % 7 == hedefTasKare%7 && sahY > hedefTasKare/8 && sahX < hedefTasKare%8) {    		
	...
	public int piyonAcmazTestYatayVeDikey(int hedefTasKare, int tasDeger, int[] tahta, PerformansTest p, int sahX, int sahY) {
		if (sahX == hedefTasKare%8 && sahY > hedefTasKare/8) {			
    		return piyonAcmaz(tasDeger,8,hedefTasKare,(sahY - hedefTasKare/8)-1,tahta,p);
    	}
    	else if (sahX == hedefTasKare%8 && sahY < hedefTasKare/8) {    		
    		return piyonAcmaz(tasDeger,7,hedefTasKare,hedefTasKare/8-sahY-1,tahta,p);
    	}
    	else if (sahY == hedefTasKare/8 && sahX > hedefTasKare%8) {    		
    		return piyonAcmaz(tasDeger,1,hedefTasKare,(sahX - hedefTasKare%8)-1,tahta,p);
    	}
    	else if (sahY == hedefTasKare/8 && sahX < hedefTasKare%8) {    		
    		return piyonAcmaz(tasDeger,2,hedefTasKare,(hedefTasKare%8-sahX)-1,tahta,p);	
    	}
	...
	public int piyonAcmazTestCapraz(int hedefTasKare, int tasDeger, int[] tahta, PerformansTest p, int sahX, int sahY) {
		if ((sahY*8+sahX) %9 == hedefTasKare%9 && sahY > hedefTasKare/8 && sahX > hedefTasKare%8) {    		
    		return piyonAcmaz(tasDeger,6,hedefTasKare,((sahY*8)+sahX-hedefTasKare)/9-1,tahta,p);
    	}
    	else if ((sahY*8+sahX) %9 == hedefTasKare%9 && sahY < hedefTasKare/8 && sahX < hedefTasKare%8) {    		
    		return piyonAcmaz(tasDeger,3,hedefTasKare,(hedefTasKare-(sahY*8+sahX))/9-1,tahta,p);
    	}
    	else if ((sahY*8+sahX) % 7 == hedefTasKare%7 && sahY > hedefTasKare/8 && sahX < hedefTasKare%8) {    		
    		return piyonAcmaz(tasDeger,5,hedefTasKare,((sahY*8)+sahX-hedefTasKare)/7-1,tahta,p);
    	}
    	else if ((sahY*8+sahX) % 7 == hedefTasKare%7 && sahY < hedefTasKare/8 && sahX > hedefTasKare%8) {    		
    		return piyonAcmaz(tasDeger,4,hedefTasKare,(hedefTasKare-(sahY*8+sahX))/7-1,tahta,p);
    	}
		return 0;
	}
	...
	public int piyonAcmaz(int tasDeger, int hangiYon, int i, int sahTaraf, int[] tahta, PerformansTest k) {			 
    	switch (hangiYon) {    	    
    	case 1:	    		    		
    		return piyonAcmazCase1(i,sahTaraf,tahta);
    	case 2:	  	    			    	
    		return piyonAcmazCase2(i,sahTaraf,tahta);	    		    	
    	case 3:	 	    			    		
    		return piyonAcmazCase3(i,tasDeger,sahTaraf,tahta,k);		    	
    	case 4:		
    		return piyonAcmazCase4(i,tasDeger,sahTaraf,tahta,k);
    	case 5:
    		return piyonAcmazCase5(i,sahTaraf,tahta);    		
    	case 6:		    		
    		return piyonAcmazCase6(i,sahTaraf,tahta);
    	case 7:	    		
    		return piyonAcmazCase7(i,sahTaraf,tahta,k);    	    
    	case 8:	    		
    		return piyonAcmazCase8(i,sahTaraf,tahta,k);
    	}	    	
    	return 0;
    }
	public int piyonAcmazCase1(int i, int sahTaraf, int[] tahta) {
		for (int p = 1;p <= sahTaraf;p++) {    			
			if (tahta[(i/8)*8+i%8+p] != 0) {	    				
				return 0;
			}
	...
	public int piyonAcmazCase2(int i, int sahTaraf, int[] tahta) {
		for (int p = 1;p <= sahTaraf;p++) {    			
			if (tahta[(i/8)*8+i%8-p] != 0) {    				
				return 0;
			}
	...
	public int piyonAcmazCase3(int i, int tasDeger, int sahTaraf, int[] tahta, PerformansTest k) {
		for (int p = 1;p <= sahTaraf;p++) {    			
			if (tahta[(i/8-p)*8+i%8-p] != 0) {    				
				return 0;
			}
	...
	public int piyonAcmazCase4(int i, int tasDeger, int sahTaraf, int[] tahta, PerformansTest k) {
		for (int p = 1;p <= sahTaraf;p++) {	    			
			if (tahta[(i/8-p)*8+i%8+p] != 0) {    				
				return 0;
			}
	...
	public int piyonAcmazCase5(int i, int sahTaraf, int[] tahta) {
		for (int p = 1;p <= sahTaraf;p++) {    			
			if (tahta[(i/8+p)*8+i%8-p] != 0) {	    					    				
				return 0;
			}
	...
	public int piyonAcmazCase6(int i, int sahTaraf, int[] tahta) {
		for (int p = 1;p <= sahTaraf;p++) {    			
			if (tahta[(i/8+p)*8+i%8+p] != 0) {	    				
				return 0;
			}
	...
	public int piyonAcmazCase7(int i, int sahTaraf, int[] tahta, PerformansTest k) {
		for (int p = 1;p <= sahTaraf;p++) {	    			
			if (tahta[(i/8-p)*8+i%8] != 0) {	    					    				
				return 0;
			}	    			
	...
	public int piyonAcmazCase8(int i, int sahTaraf, int[] tahta, PerformansTest k) {
		for (int p = 1;p <= sahTaraf;p++) {	    			
			if (tahta[(i/8+p)*8+i%8] != 0) {	    				
				return 0;
			}
	...
	public void sahCekisCapraz(int i, int[] tahta, int hedefKare) {
		 sahCekisSagUstKose(i,tahta,hedefKare);
		 sahCekisSagAltKose(i,tahta,hedefKare);
		 sahCekisSolUstKose(i,tahta,hedefKare);
		 sahCekisSolAltKose(i,tahta,hedefKare);
	 }	
	 public void sahCekisSagUstKose(int i, int[] tahta, int hedefKare) {
	 ...
	 public void sahCekisSagAltKose(int i, int[] tahta, int hedefKare) {
	 ...
	 public void sahCekisSolUstKose(int i, int[] tahta, int hedefKare) {
	 ...
	 public void sahCekisSolAltKose(int i, int[] tahta, int hedefKare) {
	 ...
	 public void sahCekenTasNerede(int tasKonum, int tasDeger, PerformansTest p) {
		 ...
		 sahCekenTasNeredeCapraz(tasKonum,p,(p.getSiyahSahKonum()/10%10)*8+p.getSiyahSahKonum()%10);		 
	 ...
	 public void sahCekenTasNeredeYatayVeDikey(int i, PerformansTest p) {
		 int tasX = i%8, tasY = i/8, sahX = p.getSiyahSahKonum()%10, sahY = p.getSiyahSahKonum()/10%10;
