...
public class Hesap {	
	...
	public double analiz(int[] tahta, boolean siraKimde) {
		...
		return minMaxDeger(mobilite,beyazMobilite,siyahMobilite,siraKimde)+materyalFark;
	}
	public double minMaxDeger(double mobilite, double beyazMobilite, double siyahMobilite, boolean siraKimde)  {
		if (siraKimde)
			return beyazMinMaxDeger(mobilite,beyazMobilite,siyahMobilite);
		else
			return siyahMinMaxDeger(mobilite,beyazMobilite,siyahMobilite);
	}
	public double beyazMinMaxDeger(double mobilite, double beyazMobilite, double siyahMobilite) {
		if (beyazMobilite > siyahMobilite) 
			return mobilite = beyazMobilite-siyahMobilite;
		 else 
			return mobilite = beyazMobilite-siyahMobilite;		
	}
	public double siyahMinMaxDeger(double mobilite, double beyazMobilite, double siyahMobilite) {		
		if (siyahMobilite > beyazMobilite) 
			return mobilite = siyahMobilite-beyazMobilite;
		else 
			return mobilite = siyahMobilite-beyazMobilite;		
	}
