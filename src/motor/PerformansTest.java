...
public class PerformansTest {
	...
	private int siyahSahKonum, beyazSahKonum, elliHamleKurali, beyazSahCekis, siyahSahCekis, sahCekenTas, gecerkenAlma = -1;
	private double[] tahta;
	
	public PerformansTest(boolean siraKimde,boolean beyazSahKisaRok,boolean beyazSahUzunRok,boolean siyahSahKisaRok,boolean siyahSahUzunRok, double[] tahta, int siyahSahKonum, int beyazSahKonum) {
