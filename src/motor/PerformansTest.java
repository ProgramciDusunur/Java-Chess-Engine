...
public class PerformansTest {
	...
	private int siyahSahKonum, beyazSahKonum, elliHamleKurali, beyazSahCekis, siyahSahCekis, gecerkenAlma = -1, beyazSahY, beyazSahX, siyahSahY, siyahSahX;
	...
	public int getBeyazSahY() {
		return beyazSahY;
	}
	public void setBeyazSahY(int beyazSahY) {
		this.beyazSahY = beyazSahY;
	}
	public int getBeyazSahX() {
		return beyazSahX;
	}
	public void setBeyazSahX(int beyazSahX) {
		this.beyazSahX = beyazSahX;
	}
	public int getSiyahSahY() {
		return siyahSahY;
	}
	public void setSiyahSahY(int siyahSahY) {
		this.siyahSahY = siyahSahY;
	}
	public int getSiyahSahX() {
		return siyahSahX;
	}
	public void setSiyahSahX(int siyahSahX) {
		this.siyahSahX = siyahSahX;
	}
}
